<%@ Page Title="Manual Create" Language="C#" MasterPageFile="~/HumanResources/HRSite.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="lewHRISlocal.HumanResources.AdminPage.Create" Debug="true"%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <h3><strong>Manually Add Corrective Action</strong></h3>
    <br />
    <p>
    ...
    <br />
        ...
        <div class="row">
            <div class="col-md-6">
                <asp:Label ID="Label16" runat="server" Text="Supervisor Who Submitted Report: " Font-Bold="True"></asp:Label> 
                <br />
                    <form autocomplete="off" action="/action_page.php">
                        <div class="autocomplete" style="width: 75%;">
                            <input id="myInput2" type="text" name="myCountry2" placeholder="Search..." class="w3-bar-item w3-input w3-border w3-round" style="height: 36px; width: 100%;">
                        ...
                        <asp:Button ID="btnSearch2" runat="server" OnClick="btnSearch2_Click" Text="&#128269;" CssClass="w3-bar-item w3-btn w3-blue w3-ripple w3-round" style="height: 36px; width: 20%;"/>
                    ...
                    <%--</form> --%> 
                    <asp:Label ID="txtSupID" runat="server" Text="Label" Visible="False"></asp:Label>
                    <%--<asp:Label ID="txtSupName" runat="server" Text="Label" Visible="False"></asp:Label>--%>
                    <asp:Label ID="txtSupEmail" runat="server" Text="Label" Visible="False"></asp:Label>
                    <asp:Label ID="txtSupUserName" runat="server" Text="Label" Visible="False"></asp:Label>
            </div>
        </div>
        <div class="row">  
            ...
            <div class="col-md-6">
                ...
                <br />
                    <%--<form autocomplete="off" action="/action_page.php">--%>
                        <div class="autocomplete" style="width: 75%;">
                            <input id="myInput" type="text" name="myCountry" placeholder="Search..." class="w3-bar-item w3-input w3-border w3-round" style="height: 36px; width: 100%;">
                            
                        </div>
                        <%--<a id="btnSearch" runat="server" onclick="btnSearch_Click" class="w3-bar-item w3-btn w3-blue w3-ripple w3-round" style="height: 36px; width: 20%;"><i class="fa fa-search"></i></a>--%>
                        <asp:Button ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="&#128269;" CssClass="w3-bar-item w3-btn w3-blue w3-ripple w3-round" style="height: 36px; width: 20%;"/>
                        <%--<button id="Button3" runat="server" onclick="btnSearch_Click" class="w3-btn w3-light-grey w3-ripple w3-round-large"><i class="fa fa-search"></i></button>--%>
                    </form>  
    ...
    <div class="row">
        <div class="col-md-4">
            <asp:Label ID="Label20" runat="server" Text="Supervisor Name: " Font-Bold="True"></asp:Label><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Employee Name Required." ControlToValidate="txtEmpName" ForeColor="Red" Font-Italic="True" Font-Size="Small"></asp:RequiredFieldValidator>--%>
            <asp:TextBox ID="txtSupName" runat="server" Width="100%" ReadOnly="true" Enabled="false" AutoPostBack="True" CssClass="w3-input w3-border w3-round"></asp:TextBox>
        </div>
        <div class="col-md-4">
        </div>
         <div class="col-md-4">
    ...
    <div>
		...
		<div class="row">
			...
			<div class="col-md-5">
                <asp:Label ID="Label9" runat="server" style="font-weight: bold" Text="Counseling Level: "></asp:Label>
                ...
                <asp:DropDownList ID="txtLevel" runat="server" CssClass="w3-select  w3-round">
        ...
        <div CssStyle="myContent">
            ...
            <br />
            <asp:Label ID="Label14" runat="server" Text="Employee Comments: *modify description as necessary" Font-Bold="True"></asp:Label>
            <br />
            <div>
                <asp:TextBox ID="txtEEComments" runat="server" Height="117px"  TextMode="MultiLine" Width="100%" CssClass="w3-input w3-border w3-round"></asp:TextBox>
            </div>
            <br />
            <asp:Label ID="Label15" runat="server" Text="Supervisor Follow Up: *modify description as necessary" Font-Bold="True"></asp:Label>
            <br />
            <div>
                <asp:TextBox ID="txtSupFollowUp" runat="server" Height="117px"  TextMode="MultiLine" Width="100%" CssClass="w3-input w3-border w3-round"></asp:TextBox>
            </div>
                <hr style="border-width: 3px; border-color: #000000" />
                ...
                <p><asp:Label ID="Label28" runat="server" style="font-weight: bold" Text="$1000 or More In Damage Assessed? "></asp:Label>
                    <asp:TextBox ID="txtDamageValue" runat="server" Font-Size="Small" Width="300px" CssClass="w3-input w3-border w3-round" ></asp:TextBox></p>
                <p><asp:Label ID="Label29" runat="server" style="font-weight: bold" Text="Disciplinary Count: "></asp:Label>
                    <asp:TextBox ID="txtCounselingCount" runat="server" Font-Size="Small" Width="300px" CssClass="w3-input w3-border w3-round" OnTextChanged="txtCounselingCount_TextChanged" AutoPostBack="True" ></asp:TextBox></p>
                <p><asp:Label ID="Label30" runat="server" style="font-weight: bold" Text="Suspension Date/s: "></asp:Label>
                    <asp:TextBox ID="txtSuspensionDate" runat="server" Font-Size="Small" Width="300px" TextMode="Date" CssClass="w3-datetime w3-border w3-round" ></asp:TextBox></p>
                <p><asp:Label ID="Label31" runat="server" style="font-weight: bold" Text="RTW: "></asp:Label>
                    <asp:TextBox ID="txtRTW" runat="server" Font-Size="Small" Width="300px" TextMode="Date" CssClass="w3-datetime w3-border w3-round" ></asp:TextBox></p>
        ...
        <hr style="border-width: 3px; border-color: #000000" />
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="Label17" runat="server" Text="Employee Acknowledged Counseling: " Font-Bold="True"></asp:Label><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Employee Name Required." ControlToValidate="txtEmpName" ForeColor="Red" Font-Italic="True" Font-Size="Small"></asp:RequiredFieldValidator>--%>
                    <asp:TextBox ID="txtEECRD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                </div>
                <div class="col-md-4">
                    <asp:Label ID="Label18" runat="server" Text="Supervisor Acknowledged Counseling: " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="txtSupCRD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                </div>
                 <div class="col-md-4">
                    <asp:Label ID="Label19" runat="server" Text="HR Acknowledged Counseling: *Enter Username" Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="txtHRCR" runat="server" Width="100%" ReadOnly="false" Enabled="true" CssClass="w3-input w3-border w3-round"></asp:TextBox>
                    <asp:TextBox ID="txtHRCRD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                 </div>
                <br />
            </div>
            <div class="row">
                <div class="col-md-4">
                    <asp:Label ID="Label21" runat="server" Text="Employee Acknowledged: " Font-Bold="True"></asp:Label><%--<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Employee Name Required." ControlToValidate="txtEmpName" ForeColor="Red" Font-Italic="True" Font-Size="Small"></asp:RequiredFieldValidator>--%>
                    <asp:TextBox ID="txtEECAD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                </div>
                <div class="col-md-4">
                    <asp:Label ID="Label22" runat="server" Text="Supervisor Acknowledged: " Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="txtSupCAD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                </div>
                 <div class="col-md-4">
                    <asp:Label ID="Label23" runat="server" Text="HRM Acknowledged: *Enter Full Name" Font-Bold="True"></asp:Label>
                    <asp:TextBox ID="txtHRMCA" runat="server" Width="100%" ReadOnly="false" Enabled="true" CssClass="w3-input w3-border w3-round"></asp:TextBox>
                    <asp:TextBox ID="txtHRMCAD" runat="server" TextMode="Date" CssClass="w3-datetime w3-border w3-round" Height="36px" Width="120px"></asp:TextBox>
                 </div>
                <br />
            </div>
        <hr style="border-width: 3px; border-color: #000000" />
    ...
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "Create.aspx/GetSupervisor",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (response) {


                autocomplete(document.getElementById("myInput2"), response.d);
            },
            error: function (response) {
                alert("error" + response.d);
            }
