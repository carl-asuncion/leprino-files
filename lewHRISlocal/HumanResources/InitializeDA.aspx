...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
        ...
        <asp:Table ID="Table2" runat="server" Width="100%">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell Width="150px"><asp:Label ID="Label7" runat="server" style="font-weight: bold" Text="Department: "></asp:Label></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell Width="150px"><asp:Label ID="Label9" runat="server" style="font-weight: bold" Text="Category: "></asp:Label></asp:TableCell>
            ...
            <asp:TableRow>
                <asp:TableCell Width="150px"><asp:Label ID="Label11" runat="server" style="font-weight: bold" Text="Sub-Category: "></asp:Label></asp:TableCell>
                ...
                <asp:TableCell Width="150px"><asp:Label ID="Label34" runat="server" style="font-weight: bold" Text="Overall Status: "></asp:Label></asp:TableCell>
    ...
    <hr style="border-width: 3px; border-color: #000000" />
            ...
            <p><asp:Label ID="Label8" runat="server" Text="Employee Comments: " Visible="false">
            </asp:Label><asp:TextBox ID="txtEmployeeComments" runat="server" TextMode="MultiLine" Rows="10" Width="100%" ReadOnly="True" Visible="false"></asp:TextBox></p>

    <hr style="border-width: 3px; border-color: #000000" />
            <h3>Forward Case to Generalist</h3>
            <asp:Label ID="Label27" runat="server" Text="Forward Case to : "><br />
            </asp:Label>
            <asp:ListBox ID="ListBox1" runat="server" SelectionMode="Multiple" Width="400px"></asp:ListBox><br />
