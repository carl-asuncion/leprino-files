...
namespace lewHRISlocal.HumanResources
{
    ...
    public partial class DashboardResultReview : System.Web.UI.Page
    {
        ...
        private void BindGrid1(string empName)
        {
            ...
            SqlCommand command = new SqlCommand("SELECT * FROM [View_1] WHERE [Employee_Status] LIKE '%" + empName + "%' AND [Overall Status] = 'Sent to HR for Review' " +
