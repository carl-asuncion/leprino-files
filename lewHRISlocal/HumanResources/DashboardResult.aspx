<%@ Page Title="Human Resources - Results" Language="C#" MasterPageFile="~/HumanResources/HRSite.Master" AutoEventWireup="true" CodeBehind="DashboardResult.aspx.cs" Inherits="lewHRISlocal.HumanResources.DashboardResult" %>
