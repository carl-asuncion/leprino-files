                ...
                <asp:Table ID="Table1" runat="server" Width="100%">
                    <asp:TableRow>
                        ...
                        <asp:TableCell HorizontalAlign="Right">
                            <asp:LinkButton ID="LinkButton1"  class="w3-btn w3-blue w3-ripple w3-round-large" runat="server" OnClick="LinkButton1_Click"><i class="fa fa-download"></i> Print View</asp:LinkButton>
