    ...
    <br />
        <h1>Counseling Record - Confirm Void</h1>
            <p>
                <asp:Table ID="Table1" runat="server" Width="100%">
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:Label ID="Label34" runat="server" Text="" Font-Italic="True"></asp:Label>
                            <br />
                        ...
                        <asp:TableCell HorizontalAlign="Right">
                            <asp:Label ID="ConfirmDelete" runat="server" Text="Click ''Confirm Void'' to Close and Void this record.  " Font-Italic="True"></asp:Label><asp:Label ID="Label38" runat="server" Text="" Font-Italic="True"></asp:Label><br />
                            <asp:LinkButton ID="LinkButton2"  class="w3-btn w3-blue w3-ripple w3-round-large" runat="server" OnClick="LinkButton2_Click" style="text-decoration:none;"><i class="fa fa-trash"></i> Confirm Void</asp:LinkButton>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </p>
        ...
        <div class="row  form-inline" style="font-family: Arial;">  
            <div class="col-md-5">
                ...
                <asp:TextBox ID="txtCounselingID" runat="server" BackColor="Transparent" BorderStyle="None" Font-Size="Small" ReadOnly="True" Width="100%" Font-Underline="false"></asp:TextBox>
            </div>
            <div class="col-md-1">
