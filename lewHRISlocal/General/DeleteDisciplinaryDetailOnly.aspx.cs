...
namespace lewHRISlocal.General
{
    ...
    public partial class DeleteDisciplinaryDetailOnly : System.Web.UI.Page
    {
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("INSERT INTO [VoidedDisciplinary] SELECT * FROM [DisciplinaryRecords] WHERE [Counseling_ID] = " + txtCounselingID.Text + "", cnn);
            command.ExecuteNonQuery();

            SqlCommand command2 = new SqlCommand("DELETE FROM [DisciplinaryRecords] WHERE [Counseling_ID] = " + txtCounselingID.Text + "", cnn);
            command2.ExecuteNonQuery();

            SqlCommand command3 = new SqlCommand("UPDATE [VoidedDisciplinary] SET [Date_Voided] = '" + System.DateTime.Now.ToString() + "' WHERE [Counseling_ID] = " + txtCounselingID.Text + "", cnn);
