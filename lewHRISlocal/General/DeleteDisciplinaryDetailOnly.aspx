<%@ Page Title="Disciplinary Detail" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeleteDisciplinaryDetailOnly.aspx.cs" Inherits="lewHRISlocal.General.DeleteDisciplinaryDetailOnly" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="background-color: rgba(255, 255, 255, 0.6); padding: 10px; border-radius: 10px; ">
    <div>
    <br />
        <h1>Disciplinary Record - Confirm Void</h1>
            <p>
                <asp:Table ID="Table1" runat="server" Width="100%">
                    <asp:TableRow>
                        ...
                        <asp:TableCell HorizontalAlign="Right">
                            <asp:Label ID="ConfirmDelete" runat="server" Text="Click ''Confirm Void'' to Close and Void this record.  " Font-Italic="True"></asp:Label><asp:Label ID="Label44" runat="server" Text="" Font-Italic="True"></asp:Label><br />
