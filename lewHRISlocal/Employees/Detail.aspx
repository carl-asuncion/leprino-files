<%@ Page Title="Detail" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="lewHRISlocal.Employees.Detail" Debug="true"%>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr style="border-width: 3px; border-color: #000000" />
    <div>
        By clicking the "Acknowledge" button, the employee is agreeing that he/she was informed of an area that requires immediate improvement. This correspondence will be kept on file as documentation of the discussion.
    </div>
    <br />
    ...
    <hr style="border-width: 3px; border-color: #000000" />
    <div>
        By clicking the "Refuse to Acknowledge" button, the employee is refusing to acknowledge the counseling submitted by the supervisor. This correspondence will still be sent to HR and will be kept on file as documentation of the discussion.
    </div><br />
    <asp:TextBox ID="TextBox2" runat="server" TextMode="SingleLine" Width="100%" Enabled="false" ReadOnly="true" Font-Italic="True"></asp:TextBox><br /><br />
            <p>
                <!--a class="btn btn-default" href="/Supervisors/SupervisorDash">Update &raquo;</a-->
